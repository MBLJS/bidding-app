    ...
    return (
        <div className="relative overflow-hidden rounded-lg">
            ...
            <a href="/auction-details" className="block">
                <img src={imageUrl} alt="Auction Item" className="w-full h-64 object-cover" loading="lazy" />
            </a>

            {/* Live Badge */}
            {isLive && (
                <div className="absolute top-4 left-4">
                    <span className="flex items-center gap-1 bg-red-500 text-white px-3 py-1 rounded-full text-sm">
            ...
            <div className="absolute top-4 right-4 flex gap-2">
                ...
                >
                    <svg className="w-5 h-5" viewBox="0 0 16 15" fill="currentColor" aria-hidden="true">
                ...
                <button
                    ...
                    className="p-2 bg-white/80 hover:bg-white rounded-full transition-colors"
                >
                    <svg className="w-5 h-5" viewBox="0 0 17 11" fill="currentColor" aria-hidden="true">
            ...
            {/* Countdown Timer */}
            <div className="absolute bottom-4 left-4 right-4 bg-white/90 rounded-lg p-2">
